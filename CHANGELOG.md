...
- Added WiFi Specific telemetry markers for triaging
- Added a change to poll wifi signal instead of fetching from BSS.
...
## [0.20.3] - 2025-10-14
### Added
- The Last Connected SSID informations are persisted at MFR Partition to support rollback to RDK Proxy
