...
## [0.9.7] - 2025-07-21
### Fixed
- Fixed the Network Connectivity Monitor to publish Internet Thunder Subsystem Ready event (cherry pick from main)
- Fixed the timing between WiFi Connected Signal and Network Connectivity Monitor restart signal

## [0.9.6] - 2025-07-01
### Fixed
- Fixed way the IIteratorType accessed within GetInitialState which lead to not kicking IPAddressChanged mitigation

## [0.9.5] - 2025-06-21
### Fixed
- Fixed the security mode thats returned for the migration API

## [0.9.4] - 2025-06-13
### Changed
- Posted DefaultInterfaceChanged only when there is actually a change; avoided redundant events

## [0.9.3] - 2025-06-05
### Changed
- Started Internet Connectivity Monitorig as soon as WIFI is connected.
- Fixed DefaultInterfaceChanged event to not to post ETH-ETH or WIFI-WIFI
