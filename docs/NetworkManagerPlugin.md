...
This document describes purpose and functionality of the org.rdk.NetworkManager interface (version 0.9.6). It includes detailed specification about its methods provided and notifications sent.
