...
This document describes purpose and functionality of the org.rdk.NetworkManager interface (version 1.12.2). It includes detailed specification about its methods provided and notifications sent.
