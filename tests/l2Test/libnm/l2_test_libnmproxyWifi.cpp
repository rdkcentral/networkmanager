...
TEST_F(NetworkManagerWifiTest, Connect_To_Known_SSID)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
    ...
    GPtrArray* dummyConns = g_ptr_array_new();
    NMConnection *conn1 = reinterpret_cast<NMConnection*>(g_object_new(NM_TYPE_REMOTE_CONNECTION, NULL));
    NMConnection *conn2 = reinterpret_cast<NMConnection*>(g_object_new(NM_TYPE_REMOTE_CONNECTION, NULL));
    NMConnection *conn3 = reinterpret_cast<NMConnection*>(g_object_new(NM_TYPE_REMOTE_CONNECTION, NULL));
    g_ptr_array_add(dummyConns, conn1);
    g_ptr_array_add(dummyConns, conn2);
    g_ptr_array_add(dummyConns, conn3);
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_connection_get_id(::testing::_))
        .WillOnce(::testing::Return(reinterpret_cast<const char*>(NULL)))
        .WillOnce(::testing::Return("TestEthConnection"))
        .WillOnce(::testing::Return("TestConnection"));
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_connection_get_connection_type(::testing::_))
        .WillOnce(::testing::Return(reinterpret_cast<const char*>("802-11-wired")))
        .WillOnce(::testing::Return(reinterpret_cast<const char*>("802-11-wireless")));
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("ConnectToKnownSSID"), _T("{ \"ssid\":\"TestConnection\" }"), response));
    EXPECT_EQ(response, _T("{\"success\":false}"));
...
TEST_F(NetworkManagerWifiTest, WiFiConnect_with_same_ssid)
{
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("WiFiConnect"), _T("{ \"ssid\":\"TestWiFiNetwork\",\"passphrase\": \"123454321\",\"security\":2, \"persist\":false}"), response));
    EXPECT_EQ(response, _T("{\"success\":true}"));
...
TEST_F(NetworkManagerWifiTest, WiFiConnect_with_no_access_point)
{
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_client_add_and_activate_connection2_finish(::testing::_, ::testing::_, ::testing::_, ::testing::_))
        .WillOnce(::testing::Invoke([](NMClient *client, GAsyncResult *result, GVariant **out_result, GError **error) -> NMActiveConnection* {
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_client_add_connection2(::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_)).Times(0);
...
TEST_F(NetworkManagerWifiTest, WiFiConnect_with_different_ssid)
{
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_bssid(::testing::_))
        .WillOnce(::testing::Return("AA:BB:CC:DD:EE:FF"))
        .WillOnce(::testing::Return("AA:BB:CC:DD:EE:F2"));
    
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_frequency(::testing::_))
        .WillOnce(::testing::Return(static_cast<guint32>(2462))) // Channel 11 (2.4GHz)
        .WillOnce(::testing::Return(static_cast<guint32>(2462)));
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_max_bitrate(::testing::_))
        .WillOnce(::testing::Return(static_cast<guint32>(54000))) // 54 Mbps
        .WillOnce(::testing::Return(static_cast<guint32>(54000)));
    
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_strength(::testing::_))
        .WillOnce(::testing::Return(static_cast<guint32>(85))) // 85% signal strength
        .WillOnce(::testing::Return(static_cast<guint32>(85)));
...
TEST_F(NetworkManagerWifiTest, WiFiConnect_with_connection_update)
{
    GPtrArray* dummyConns = g_ptr_array_new();
    NMConnection *conn = static_cast<NMConnection*>(g_object_new(NM_TYPE_REMOTE_CONNECTION, NULL));
    g_ptr_array_add(dummyConns, conn);
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_remote_connection_update2(::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_, ::testing::_))
        .WillOnce(::testing::Invoke([](NMRemoteConnection *connection, GVariant *settings, NMSettingsUpdate2Flags flags, GVariant *args, GCancellable *cancellable, GAsyncReadyCallback callback, gpointer user_data) {
                if (callback) {
                    GObject* source_object = G_OBJECT(connection);
                    callback(source_object, nullptr, user_data);
                }
        }));

    EXPECT_CALL(*p_libnmWrapsImplMock, nm_connection_get_id(::testing::_))
        .WillOnce(::testing::Return(reinterpret_cast<const char*>("TestWiFiNetwork_2")));

    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_connection_valid(::testing::_, ::testing::_))
        .WillOnce(::testing::Return(TRUE));

    EXPECT_CALL(*p_libnmWrapsImplMock, nm_device_get_available_connections(::testing::_))
        .WillOnce(::testing::Return(reinterpret_cast<GPtrArray*>(dummyConns)));

    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("WiFiConnect"), _T("{ \"ssid\":\"TestWiFiNetwork_2\",\"passphrase\": \"123499054\",\"security\":1, \"persist\":true}"), response));
    EXPECT_EQ(response, _T("{\"success\":false}"));
...
TEST_F(NetworkManagerWifiTest, WiFiConnect_with_connection_not_valid)
{
    GPtrArray* dummyConns = g_ptr_array_new();
    NMConnection *conn = static_cast<NMConnection*>(g_object_new(NM_TYPE_REMOTE_CONNECTION, NULL));
    g_ptr_array_add(dummyConns, conn);
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_remote_connection_delete(::testing::_, ::testing::_, ::testing::_))
        .WillOnce(::testing::Invoke([](NMRemoteConnection *connection, GCancellable *cancellable, GError **error) -> gboolean {
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("WiFiConnect"), _T("{ \"ssid\":\"TestWiFiNetwork_2\",\"passphrase\": \"123499054\",\"security\":1, \"persist\":false}"), response));
    EXPECT_EQ(response, _T("{\"success\":false}"));
...
TEST_F(NetworkManagerWifiTest, WiFiConnect_new_connection_persist_true_uses_legacy_add_and_activate)
{
    ...
    const char* ssid_str = "TestWiFiNetwork_3";
    GBytes* fake_ssid = g_bytes_new_static(ssid_str, strlen(ssid_str));
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_rsn_flags(::testing::_))
        .WillOnce(::testing::Return(static_cast<NM80211ApSecurityFlags>(NM_802_11_AP_SEC_KEY_MGMT_PSK)));
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_bssid(::testing::_))
        .WillOnce(::testing::Return("AA:BB:CC:DD:EE:F3"));
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_frequency(::testing::_))
        .WillOnce(::testing::Return(static_cast<guint32>(2462)));
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_access_point_get_mode(::testing::_))
        .WillOnce(::testing::Return(static_cast<NM80211Mode>(NM_802_11_MODE_INFRA)));
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("WiFiConnect"), _T("{ \"ssid\":\"TestWiFiNetwork_3\",\"passphrase\": \"123499054\",\"security\":1, \"persist\":true}"), response));
    EXPECT_EQ(response, _T("{\"success\":true}"));
...
TEST_F(NetworkManagerWifiTest, AddToKnownSSIDs_sae_update_success)
{
    GPtrArray* dummyConns = g_ptr_array_new();
    NMConnection *conn = static_cast<NMConnection*>(g_object_new(NM_TYPE_REMOTE_CONNECTION, NULL));
    g_ptr_array_add(dummyConns, conn);
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_remote_connection_update2_finish(::testing::_, ::testing::_, ::testing::_))
        .WillOnce(::testing::Invoke([](NMRemoteConnection *connection, GAsyncResult *result, GError **error) -> GVariant* {
            GVariant* newVariant = g_variant_new_string("UpdatedVariant");
            return newVariant;
        }));
...
TEST_F(NetworkManagerWifiTest, AddToKnownSSIDs_sae_update_failed)
{
    GPtrArray* dummyConns = g_ptr_array_new();
    NMConnection *conn = static_cast<NMConnection*>(g_object_new(NM_TYPE_REMOTE_CONNECTION, NULL));
    g_ptr_array_add(dummyConns, conn);
...
TEST_F(NetworkManagerWifiTest, GetKnownSSIDs_success)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
...
TEST_F(NetworkManagerWifiTest, RemoveKnownSSIDs)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
    ...
    EXPECT_EQ(Core::ERROR_NONE, handler.Invoke(connection, _T("RemoveKnownSSID"), _T(""), response));
    EXPECT_EQ(response, _T("{\"success\":false}"));
...
TEST_F(NetworkManagerWifiTest, RemoveKnownSSIDs_success_false)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_connection_get_id(::testing::_))
        .WillOnce(::testing::Return(reinterpret_cast<const char*>("Test_wifi")));
...
TEST_F(NetworkManagerWifiTest, RemoveKnownSSIDs_success_true)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
...
TEST_F(NetworkManagerWifiTest, RemoveKnownSSIDs_conn_id_null)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
...
TEST_F(NetworkManagerWifiTest, RemoveKnownSSIDs_success_ssid_specified_not_found)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
...
TEST_F(NetworkManagerWifiTest, RemoveKnownSSIDs_success_ssid_specified_found)
{
    GPtrArray* fakeDevices = g_ptr_array_new();
    NMDevice *deviceDummy = static_cast<NMDevice*>(g_object_new(NM_TYPE_DEVICE_WIFI, NULL));
    g_ptr_array_add(fakeDevices, deviceDummy);
    ...
    EXPECT_CALL(*p_libnmWrapsImplMock, nm_connection_get_id(::testing::_))
        .WillOnce(::testing::Return(reinterpret_cast<const char*>("TestNetwork")));
