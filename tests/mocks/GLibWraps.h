...
public:
    ...
    virtual guint g_signal_handlers_disconnect_by_data(gpointer instance, gpointer data) = 0;
    virtual guint g_signal_handlers_disconnect_by_func(gpointer instance, gpointer func, gpointer data) = 0;
};
...
public:
    ...
    static guint g_signal_handlers_disconnect_by_data(gpointer instance, gpointer data) __attribute__((visibility("default")));
    static guint g_signal_handlers_disconnect_by_func(gpointer instance, gpointer func, gpointer data) __attribute__((visibility("default")));
};
