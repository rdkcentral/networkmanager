...
public:
    ...
    MOCK_METHOD(uint32_t, RegisterInterfaceStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IIfaceStateChangeNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterInterfaceStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IIfaceStateChangeNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterActiveInterfaceChangeNotification, (WPEFramework::Exchange::INetworkManager::IActiveIfaceNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterActiveInterfaceChangeNotification, (WPEFramework::Exchange::INetworkManager::IActiveIfaceNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterIPAddressChangeNotification, (WPEFramework::Exchange::INetworkManager::IIPAddNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterIPAddressChangeNotification, (WPEFramework::Exchange::INetworkManager::IIPAddNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterInternetStatusChangeNotification, (WPEFramework::Exchange::INetworkManager::IInetStatNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterInternetStatusChangeNotification, (WPEFramework::Exchange::INetworkManager::IInetStatNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterAvailableSSIDsNotification, (WPEFramework::Exchange::INetworkManager::IAvailSSIDsNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterAvailableSSIDsNotification, (WPEFramework::Exchange::INetworkManager::IAvailSSIDsNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterWiFiStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiStateNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterWiFiStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiStateNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterWiFiSignalQualityChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiSigQualityNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterWiFiSignalQualityChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiSigQualityNotify* notification), (override));
