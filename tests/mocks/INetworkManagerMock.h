...
public:
    ...
    MOCK_METHOD(uint32_t, RegisterInterfaceStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IInterfaceStateChangeNotification* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterInterfaceStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IInterfaceStateChangeNotification* notification), (override));
    MOCK_METHOD(uint32_t, RegisterActiveInterfaceChangeNotification, (WPEFramework::Exchange::INetworkManager::IActiveInterfaceChangeNotification* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterActiveInterfaceChangeNotification, (WPEFramework::Exchange::INetworkManager::IActiveInterfaceChangeNotification* notification), (override));
    MOCK_METHOD(uint32_t, RegisterIPAddressChangeNotification, (WPEFramework::Exchange::INetworkManager::IIPAddressChangeNotification* notification), (override);
    MOCK_METHOD(uint32_t, UnregisterIPAddressChangeNotification, (WPEFramework::Exchange::INetworkManager::IIPAddressChangeNotification* notification), (override);
    MOCK_METHOD(uint32_t, RegisterInternetStatusChangeNotification, (WPEFramework::Exchange::INetworkManager::IInternetStatusChangeNotification* notification), (override);
    MOCK_METHOD(uint32_t, UnregisterInternetStatusChangeNotification, (WPEFramework::Exchange::INetworkManager::IInternetStatusChangeNotification* notification), (override);
    MOCK_METHOD(uint32_t, RegisterAvailableSSIDsNotification, (WPEFramework::Exchange::INetworkManager::IAvailableSSIDsNotification* notification), (override);
    MOCK_METHOD(uint32_t, UnregisterAvailableSSIDsNotification, (WPEFramework::Exchange::INetworkManager::IAvailableSSIDsNotification* notification), (override);
    MOCK_METHOD(uint32_t, RegisterWiFiStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiStateChangeNotification* notification), (override);
    MOCK_METHOD(uint32_t, UnregisterWiFiStateChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiStateChangeNotification* notification), (override);
    MOCK_METHOD(uint32_t, RegisterWiFiSignalQualityChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiSignalQualityChangeNotification* notification), (override);
    MOCK_METHOD(uint32_t, UnregisterWiFiSignalQualityChangeNotification, (WPEFramework::Exchange::INetworkManager::IWiFiSignalQualityChangeNotification* notification), (override);
