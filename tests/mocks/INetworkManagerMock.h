...
public:
    ...
    MOCK_METHOD(uint32_t, RegisterIfaceStateNotify, (WPEFramework::Exchange::INetworkManager::IIfaceStateChangeNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterIfaceStateNotify, (WPEFramework::Exchange::INetworkManager::IIfaceStateChangeNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterActiveIfaceNotify, (WPEFramework::Exchange::INetworkManager::IActiveIfaceNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterActiveIfaceNotify, (WPEFramework::Exchange::INetworkManager::IActiveIfaceNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterIPAddNotify, (WPEFramework::Exchange::INetworkManager::IIPAddNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterIPAddNotify, (WPEFramework::Exchange::INetworkManager::IIPAddNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterInetStatNotify, (WPEFramework::Exchange::INetworkManager::IInetStatNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterInetStatNotify, (WPEFramework::Exchange::INetworkManager::IInetStatNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterAvailSSIDsNotify, (WPEFramework::Exchange::INetworkManager::IAvailSSIDsNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterAvailSSIDsNotify, (WPEFramework::Exchange::INetworkManager::IAvailSSIDsNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterWiFiStateNotify, (WPEFramework::Exchange::INetworkManager::IWiFiStateNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterWiFiStateNotify, (WPEFramework::Exchange::INetworkManager::IWiFiStateNotify* notification), (override));
    MOCK_METHOD(uint32_t, RegisterWiFiSigQualityNotify, (WPEFramework::Exchange::INetworkManager::IWiFiSigQualityNotify* notification), (override));
    MOCK_METHOD(uint32_t, UnregisterWiFiSigQualityNotify, (WPEFramework::Exchange::INetworkManager::IWiFiSigQualityNotify* notification), (override));
